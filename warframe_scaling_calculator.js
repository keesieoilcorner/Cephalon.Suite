...
const queryFields = {
    ...
    baseHealth:     { els: [baseHealthEl, baseHealthRangeEl], def: 100 },
    baseShield:     { els: [baseShieldEl, baseShieldRangeEl], def: 0 },
    baseArmor:      { els: [baseArmorEl, baseArmorRangeEl], def: 200 },
    baseDamage:     { els: [baseDamageEl, baseDamageRangeEl], def: 100 },
